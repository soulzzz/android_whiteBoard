package com.goke.whiteboard.view;
...
import com.goke.wblib.bean.DrawPoint;
import com.goke.wblib.utils.Events;
import com.goke.wblib.utils.OperationUtils;
import com.goke.wblib.utils.WhiteBoardVariable;
import com.goke.wblib.widget.DrawPenView;
import com.goke.wblib.widget.DrawTextLayout;
import com.goke.wblib.widget.DrawTextView;
import com.goke.whiteboard.R;
import com.goke.whiteboard.utils.StoreUtil;
import com.goke.whiteboard.view.base.BaseActivity;
import com.goke.whiteboard.view.widget.floatingactionmenu.FloatingActionsMenu;
import com.goke.whiteboard.view.widget.floatingactionmenu.FloatingImageButton;
...
public class WhiteBoardActivity extends BaseActivity implements View.OnClickListener {
    private final String TAG ="WB_WhiteBoardActivity";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_white_board_export://保存白板操作集到本地
                ...
                StoreUtil.saveWhiteBoardPoints(WhiteBoardActivity.this);
                break;
...
//        mRlContent.setLayoutParams(mLayoutParams);
    ...
    public void saveImage() {
        String fileName = StoreUtil.getPhotoSavePath(this);
        ...
        try {
            ...
            Toast.makeText(this,getString(R.string.white_board_export_tip) + fileName,Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            showMessage(getString(R.string.white_board_export_fail));
            e.printStackTrace();
        }
    ...
    public void onReceiveMsg2(String message) {
        Log.d(TAG, "onReceiveMsg2: "+message);
        if(message ==Events.WHITE_BOARD_TEXT_EDIT ){
            Log.d(TAG, "onReceiveMsg2222: "+message);
            textEdit();
        }
    }
...
//        mRlContent.setLayoutParams(mLayoutParams);
    ...
    public void onReceiveMsg(String message) {
        ...
        if(message ==Events.WHITE_BOARD_UNDO_REDO ){
            showUndoRedo();
        }
    }
